 ...
 */
final class Version20230402154050 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE main_wallet_wallet (main_wallet_id INT NOT NULL, wallet_id INT NOT NULL, INDEX IDX_7E6CBEC651938751 (main_wallet_id), INDEX IDX_7E6CBEC6712520F3 (wallet_id), PRIMARY KEY(main_wallet_id, wallet_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
