 ...
 */
final class Version20230330181922 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_47948BBC9D86650F ON depot');
        $this->addSql('ALTER TABLE depot CHANGE user_id_id user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE depot CHANGE user_id user_id_id INT NOT NULL');
        $this->addSql('ALTER TABLE depot ADD CONSTRAINT FK_47948BBC9D86650F FOREIGN KEY (user_id_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_47948BBC9D86650F ON depot (user_id_id)');
    }
}
